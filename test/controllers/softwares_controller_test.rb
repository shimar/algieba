...
class SoftwaresControllerTest < ActionController::TestCase
  ...
  test "should create software" do
    assert_difference('Software.count') do
      post :create, software: { description: @software.description, name: @software.name, user_id: @software.user_id }
    end
  ...
  test "should update software" do
    patch :update, id: @software, software: { description: @software.description, name: @software.name, user_id: @software.user_id }
    assert_redirected_to software_path(assigns(:software))
  end
